...
// 连接zkserver
void ZkClient::Start() {
    std::string host = MprpcApplication::GetInstance().GetConfigure().Load("zookeeperip");
    std::string port = MprpcApplication::GetInstance().GetConfigure().Load("zookeeperport");
